...
// The replace function is interpreting $ as a special replacement character, ruining the string.
// Instead of using a regex replace with strings, I will manually build the string and write it.

const firstPart = content.split("describe('AIService.checkRegex'")[0];

const newPart = `describe('AIService.checkRegex', () => {
  let consoleWarnSpy;
...
fs.writeFileSync('app/services/AIService.test.js', firstPart + newPart, 'utf8');
