            ...
            {(() => {
                ...
                <div className="border-t border-border pt-4 mt-4">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button type="button" aria-label="Send follow-up question" title="Send follow-up question" onClick={handleSend} disabled={sendingFollowUp || !followUpText.trim()} className="bg-primary text-primary-foreground p-2 rounded-lg hover:bg-primary/90 disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
