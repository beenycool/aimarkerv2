            ...
            {(() => {
                ...
                <div className="border-t border-border pt-4 mt-4">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button type="button" onClick={handleSend} disabled={sendingFollowUp || !followUpText.trim()} className="bg-primary text-primary-foreground p-2 rounded-lg hover:bg-primary/90 disabled:opacity-50" aria-label="Send follow-up question">
                ...
                <button type="button" onClick={onNext} className="w-full mt-2 py-3 bg-primary hover:bg-orange-600 text-white rounded-lg font-semibold flex items-center justify-center gap-2 transition-colors">
