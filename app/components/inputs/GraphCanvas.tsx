        ...
        <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2 bg-muted/50 p-2 rounded-lg border border-border">
                ...
                {backgroundImage && onClearBackground && (
                    <button aria-label="Remove figure background" onClick={onClearBackground} className="p-2 rounded hover:bg-muted text-muted-foreground" title="Remove figure background">
                        <ImageOff className="w-4 h-4" />
                    </button>
                )}
                <button aria-label="Clear canvas" onClick={() => onChange({ points: [], lines: [], labels: [], paths: [] })} className="p-2 rounded hover:bg-destructive/10 text-destructive"><Trash2 className="w-4 h-4" /></button>
            </div>
