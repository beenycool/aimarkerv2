...
const PaperCard = React.memo(({ paper, hasSession, isDeleting, onSelect, onDelete, onResume }) => {
    return (
        <Card
...
export const PaperLibrary = ({ onSelectPaper, onResumePaper, checkSessionForPaper }) => {
    ...
    const handleDelete = React.useCallback(async (e, paper) => {
        e.stopPropagation();
    ...
    const handleSelect = React.useCallback(async (paper) => {
